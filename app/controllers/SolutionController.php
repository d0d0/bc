...
class SolutionController extends BaseController {
    ...
    public function add() {
        if (Request::ajax()) {
            ...
            shell_exec('timeout 20s ' . $path . '/main --gtest_color=yes --gtest_break_on_failure --gtest_output=xml:/var/www/bc/app/storage/s.xml | sh /home/jduc/gtest-1.7.0/samples/ansi2html.sh > ' . $path . '/test.html');
