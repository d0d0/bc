...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            if (this.options.searchDate && typeof datetimepicker === 'object') {
                html.push(
                        '<div class="pull-' + this.options.searchAlign + ' search searchDate col-md-2 input-group">',
                        sprintf('<input class="form-control" type="text" placeholder="%s" maxlength="10">',
            ...
            this.$toolbar.append(html.join(''));
            if (this.options.searchDate && typeof datetimepicker === 'object') {
                var searchDate = this.$toolbar.find('.searchDate');
            ...
            $search.off('keyup').on('keyup', function (event) {
                ...
                var that1 = $(this);
                timeoutId = setTimeout(function () {
                    that.onSearch($(that1).val());
                }, that.options.searchTimeOut);
            });
        }
    };

    BootstrapTable.prototype.onSearch = function (val) {
        var text = $.trim(val);
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            html.push('<tr',
                    ...
                    sprintf(' id="%s"', data[i].id ? data[i].id : undefined),
